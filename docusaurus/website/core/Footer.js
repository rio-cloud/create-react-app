            ...
            <footer className="nav-footer" id="footer">
                <section className="sitemap">
                    ...
                    <div>
                        ...
                        <a href="https://spectrum.chat/create-react-app" target="_blank" rel="noreferrer noopener">
                            Spectrum
                        </a>
                        <a href="https://twitter.com/reactjs" target="_blank" rel="noreferrer noopener">
                            Twitter
                        </a>
                        <a
