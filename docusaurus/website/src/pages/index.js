...
function Home() {
    ...
    return (
        <Layout permalink={'/'} description={'Set up a modern web app by running one command.'}>
                ...
                <div className="container padding-vert--xl text--left">
                    <div className="row">
                        ...
                        <div className="col col--5 col--offset-1">
                            ...
                            <p>
                                Updating your build tooling is typically a daunting and time-consuming task. When new
                                versions of Create React App are released, you can upgrade using a single command:
                            </p>
